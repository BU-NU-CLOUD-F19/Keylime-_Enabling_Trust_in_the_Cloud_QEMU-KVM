...
def main():
	...
	data2 = []
	tree2 = MerkleTree(data2, hashfunc)
	tree2.append('a')
	root2 = tree2._root
	original_proof2 = tree2.get_proof('a')
	print(original_proof2)

	print("Proof to string test")
	string_proof = proof_to_string(original_proof2)
	...
	print(merklelib.verify_leaf_inclusion('a', new_proof, hashfunc, utils.to_hex(root2.hash)))
